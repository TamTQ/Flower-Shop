<%-- 
    Document   : canceledOrders.jsp
    Created on : Jun 8, 2022, 8:20:40 PM
    Author     : admin
--%>
            ...
            <table class="order">
                ...
                <tr><td><%= ord.getOrderID()%></td>
                    ...
                    <td><%= status[ord.getStatus()]%>
                        <br/><% if (ord.getStatus() == 3)%><a href='orderstatusServlet?orderstatus=3&orderid=<%= ord.getOrderID() %>'>order again</a>
                    </td>
